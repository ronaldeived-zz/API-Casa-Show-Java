...
public class EventoResourceExceptionHandler {
	...
	public ResponseEntity<DetalhesErro> handlerEventoExistenteException(EventoExistenteException e,
			HttpServletRequest request) {
	...
	public ResponseEntity<DetalhesErro> handlerMismatchedInputException(MismatchedInputException e,
			HttpServletRequest request) {
	...
	(EntityNotFoundException e, HttpServletRequest request){
		...
		DetalhesErro erro = new DetalhesErro();
		erro.setStatus(400l);
		erro.setTitulo("Requisição inválida. Não pode alterar os dados da casa de show.");
		erro.setTimestamp(System.currentTimeMillis());
